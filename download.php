...
<head>
  ...
  <title> .: Download :. : File Management system @ IST.SUT </title>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
          ...
          <!-- admin only -->
          <li class="btn-trial"><a href="add.php">สร้าง</a></li>
          <li class="btn-trial"><a href="manage.php">จัดการ</a></li>
           <!-- admin only -->
          ...
          <table class="table table-hover table-responsive">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <a href="#"><i class="fa fa-file fa-2" aria-hidden="true"></i> ดาวน์โหลด </h>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  รายงานการประชุมคณะกรรมการ exmple 2
                </td>
                <td>
                  Fri, 10 Nov 2017 
                </td>
                <td>
                  <a href="#"><i class="fa fa-file fa-2" aria-hidden="true"></i> ดาวน์โหลด</a>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  รายงานการประชุมคณะกรรมการ exmple 3
                </td>
                <td>
                  Fri, 10 Nov 2017 
                </td>
              ...
              <tr>
                ...
                <td>
                  รายงานการประชุมคณะกรรมการ exmple 4
                </td>
                <td>
                  Fri, 10 Nov 2017 
                </td>
